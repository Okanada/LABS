...
<body>
	...
	@include('partials.partials_home.header')

	@include('partials.partials_home.carousel')

	  @yield('content-home')

	@include('partials.partials_home.contact')

	@include('partials.partials_home.footer')
