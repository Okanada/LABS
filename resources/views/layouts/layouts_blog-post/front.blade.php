...
<body>
    ...
    @include('partials.partials_blog-post.header')

     @yield('content_blog-post')

    @include('partials.partials_blog-post.newsletter')
    @include('partials.partials_blog-post.footer')
